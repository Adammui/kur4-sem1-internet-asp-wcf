...
namespace lab_6_client
{
    public partial class MainWindow : Window
    {
        ...
        private readonly WsPINEntities _entities;

        public MainWindow()
        {
            _entities = new WsPINEntities(_serviceUrl);
            InitializeComponent();
        }

        public void OnGetStudentsClick(object sender, RoutedEventArgs e) => Exec(new WsPINEntities(_serviceUrl).Students);

        public void OnGetNotesClick(object sender, RoutedEventArgs e) => Exec(new WsPINEntities(_serviceUrl).Notes);
